  ...
  return (
    <>
      ...
      <div className="wp-container">
        {/* ════════════ COVER PAGE ════════════ */}
        <div className="wp-cover" style={{ position: "relative", overflow: "hidden" }}>
          {/* 000 watermark */}
          <div style={{
            position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)",
            fontFamily: "'JetBrains Mono', monospace", fontSize: "280pt", fontWeight: 900,
            color: "rgba(220, 38, 38, 0.04)", lineHeight: 1, letterSpacing: "-0.02em",
