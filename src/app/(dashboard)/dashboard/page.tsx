      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
        {[
          ...
          <Link
            key={stat.label}
            href={stat.href}
            className="group bg-surface-card border border-border-light rounded-sm p-6 transition-all duration-300 hover:border-border-red-subtle hover:bg-surface-card-hover"
          >
            <stat.icon
              size={20}
              className="mb-3"
            ...
            />
            <div className="font-mono text-3xl font-light mb-1" style={{ color: stat.color }}>
              {stat.value}
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div>
            ...
            <div className="font-body text-xs text-text-muted">
              Score a campaign with the R IF C Calculator
            </div>
          </div>
        </Link>
        <Link
        ...
        >
          ...
          <div>
            ...
            <div className="font-body text-xs text-text-muted">
              Read the latest R IF C insights
            </div>
          </div>
        </Link>
      </div>
