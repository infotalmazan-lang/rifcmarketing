                          ...
                          <div style={{ ...S.configCard, padding: 0, overflow: "auto" }}>
                            ...
                            {tooltipCol && (() => {
                              const tips: Record<string, { title: string; desc: string }> = {
                                ...
                                R: { title: "R — Relevanță (Relevance)", desc: "Scor mediu 1-10. Masoara cat de relevant este mesajul pentru audienta tinta. R functioneaza ca un GATE (prag): daca R < 3, comunicarea este considerata irelevanta si scorul C se prabuseste indiferent de I si F.\n\nInterpretare: 1-2 = irelevant (sub prag, Gate activ). 3-6 = relevant moderat. 7-8 = relevant. 9-10 = extrem de relevant." },
