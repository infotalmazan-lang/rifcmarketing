                          ...
                          <div style={{ ...S.configCard, padding: 0, overflow: "auto" }}>
                            ...
                            {tooltipCol && (() => {
                              const tips: Record<string, { title: string; desc: string }> = {
                                ...
                                R: { title: "R — Relevanță (Relevance)", desc: "Scor mediu 1-10. Masoara cat de relevant este mesajul pentru audienta tinta. R functioneaza ca un GATE (prag): daca R < 4, comunicarea este considerata irelevanta si scorul C se prabuseste indiferent de I si F.\n\nInterpretare: 1-3 = irelevant (sub prag, Gate activ). 4-6 = relevant moderat. 7-8 = relevant. 9-10 = extrem de relevant." },
                                I: { title: "I — Interes (Interest)", desc: "Scor mediu 1-10. Masoara cat de interesant este continutul materialului — gradul de atentie si curiozitate pe care il genereaza. I si F au relatie multiplicativa (I × F) in formula RIFC.\n\nInterpretare: 1-3 = neinteresant. 4-6 = interes moderat. 7-8 = captivant. 9-10 = extrem de interesant." },
                                F: { title: "F — Formă (Form/Execution)", desc: "Scor mediu 1-10. Masoara calitatea executiei vizuale si structurale a materialului — design, layout, claritate vizuala. F amplifica sau diminueaza Interesul prin relatia multiplicativa I × F.\n\nInterpretare: 1-3 = executie slaba. 4-6 = executie acceptabila. 7-8 = executie buna. 9-10 = executie excelenta." },
                                Cform: { title: "C(form) — Claritate (Formula)", desc: "Scorul de claritate si putere de conversie calculat dupa formula RIFC: R + (I × F) = C. R este baza aditiva (relevanța), iar I × F este amplificatorul multiplicativ (interes × forma).\n\nInterval: minim 2 (R=1, I=1, F=1), maxim 110 (R=10, I=10, F=10).\n\nInterpretare: < 20 = comunicare slaba. 20-40 = sub medie. 40-60 = medie. 60-80 = buna. > 80 = excelenta." },
